...
<div id="container" class="container-fluid">
    ...
    <div id="top" class="row">
        ...
        <div class="col-md-3">
            <a href="/crud-manager/product/form" class="btn btn-danger pull-right h2"><span class="glyphicon glyphicon-plus" /></span>&nbspAdicionar Produto</a>
        </div>
    </div>
                    ...
                    <tr>
                        ...
                        <td class="actions">
                            <a class="btn btn-danger btn-xs modal-remove"
                               ...
                               product-name="${product.getName()}" data-toggle="modal"
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        // ao clicar no delete de algum produto, pega o nome do produto, 
        // o id do produto e a ação (delete) e envia para o modal 
        $(".modal-remove").click(function () {
            var productName = $(this).attr('product-name');
            var productId = $(this).attr('product-id');
            $(".modal-body #hiddenValue").text("o produto '"+productName+"'");
